<template>
  ...
  >
    <defs>
      <radialGradient
        id="mouse-graphic-events-a"
        cx="100%"
        cy="50%"
        r="97.147%"
        fx="100%"
        fy="50%"
        gradientTransform="matrix(-.06544 .51468 -.99786 -.03375 1.564 .002)"
      >
        <stop
          offset="0%"
          stop-color="#FFF"
